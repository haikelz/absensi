...
var AdminModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            controllers: [
                admin_controller_1.SignInAdminController,
                admin_controller_1.StatisticsAdminController,
                admin_controller_1.DetailStatisticsStudentInAdminContoller,
            ],
            providers: [
                admin_service_1.SignInAdminService,
                admin_service_1.StatisticsAdminService,
                admin_service_1.DetailStatisticsStudentInAdminService,
            ],
        })];
